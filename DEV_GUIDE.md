...
📝 목표 단어 수: 2000-3500자
🎯 SEO 키워드: NVIDIA, Blackwell GPU, AI 칩, 반도체, 주가 전망

✅ 필수 구성 (11단계):

1. 제목 (60자 이내)
   - 예: "NVIDIA Blackwell GPU 출시, AI 시장 지배력 강화 - 주가 전망은?"
...
6. 수치로 보는 분석 (표 형식)
   | 항목 | 현재 | 전망 |
   |------|------|------|
   | GPU 성능 | H100 기준 | 30배 향상 |
   | 시장 점유율 | 80% | 85% |
   | 매출 성장률 | YoY 200% | YoY 250% |
